...
<head>
  ...
  <link rel="stylesheet" href="../css/form_seminar.css">
  <title>Form Input Seminar</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | Seminar</h5>
    </div>
    <form method="POST" action="simpan_seminar.php" enctype="multipart/form-data">
      ...
      <a href="tampil_seminar.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
