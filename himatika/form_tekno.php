...
<head>
  ...
  <link rel="stylesheet" href="../css/form_tekno.css">
  <title>Form Input Teknologi Terkini</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | Teknologi Terkini</h5>
    </div>
    <form method="POST" action="simpan_tekno_terkini.php" enctype="multipart/form-data">
      ...
      <a href="tampil_tekno_terkini.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
