...
<head>
  ...
  <link rel="stylesheet" href="../css/form_film.css">
  <title>Form Input Film</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | FILM</h5>
    </div>
    <form method="POST" action="simpan_film.php" enctype="multipart/form-data">
      ...
      <a href="tampil_film.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
