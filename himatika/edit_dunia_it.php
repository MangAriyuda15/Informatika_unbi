...
<head>
    ...
    <title>Data Dunia IT</title>
    <link rel="stylesheet" href="../css/edit_dunia_it.css">
</head>
<body>
    <?php
    include ("koneksi/koneksi.php");
$id=$_GET['id'];
$edit="SELECT * FROM duniait WHERE id_duniait='$id'";
...
<!---CODING HTML--->
<form method="GET" action=update_dunia_it.php>
            <input type="hidden" name="id" value="<?php echo $data['id_duniait'];?>">
