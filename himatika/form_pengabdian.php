...
<head>
  ...
  <link rel="stylesheet" href="../css/form_pengabdian.css">
  <title>Form Input Pengabdian</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | Pengabdian</h5>
    </div>
    <form method="POST" action="simpan_pengabdian.php" enctype="multipart/form-data">
    <div class="form-group menu2">
      ...
      <a href="tampil_pengabdian.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
