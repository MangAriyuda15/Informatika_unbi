...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | PENGUMUMAN</h5>
    </div>
    <form method="POST" action="simpan_pengumuman.php" enctype="multipart/form-data">
      <div class="form-group menu1">
        <label for="judul">Judul Berita</label>
        <input type="text" name="judul" class="form-control">
      </div>
      <div class="form-group menu1">
        <label for="info">Info Berita</label>
        <textarea name="info" rows="6" type="text" class="form-control" id="info"></textarea>
      </div>
      <br>
      <br>
      <button type="submit" class="btn btn-primary">Simpan</button> 
      <a href="tampil_pengumuman.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
