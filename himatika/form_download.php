...
<head>
  ...
  <link rel="stylesheet" href="../css/form_prospek_kerja.css">
  <title>Form Input Download</title>
...
<body>
          ...
          <div class="container-fluid color1">
            ...
            <div class="collapse navbar-collapse menu1 " id="navbarSupportedContent">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="form_download.php">form download</a>
                </li>
                <li class="nav-item">
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | DOWNLOAD</h5>
    </div>
    <form method="POST" action="simpan_download.php" enctype="multipart/form-data">
      <br>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="custom-file">
                  <input type="file" name="nama_file" id="nama_file" class="imgFile custom-file-input" aria-describedby="inputGroupFileAddon01">
                  <label class="custom-file-label" for="inputFile">File PDF</label>
                </div>
              </div>
            </div>
          </div>
      ...
      <a href="tampil_download.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
