...
<head>
  ...
  <link rel="stylesheet" href="../css/form_dosen.css">
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita |Dosen</h5>
    </div>
    <form method="POST" action="simpan_dosen.php" enctype="multipart/form-data">
     <div class="form-group menu1">
      ...
      <a href="tampil_dosen.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
