...
<head>
    ...
    <link rel="stylesheet" href="../css/edit_pengabdian.css">
</head>
<body>
    <?php
    include ("koneksi/koneksi.php");
$id=$_GET['id'];
$edit="SELECT * FROM pengabdian WHERE id_pengabdian='$id'";
...
<!---CODING HTML--->
<form method="GET" action=update_pengabdian.php>
            <input type="hidden" name="id" value="<?php echo $data['id_pengabdian'];?>">
