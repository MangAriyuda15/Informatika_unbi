...
<head>
    ...
    <link rel="stylesheet" href="../css/update_film.css"> 
</head>
    ...
    <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="edit_film.php?id=<?php echo $row['id_film']; ?>">
                        <button type="button" class="btn btn-warning btn-sm">Edit</button></a> |
                        <a href="hapus_film.php?id=<?php echo $row['id_film']; ?>">
