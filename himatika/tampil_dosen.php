...
<head>
    ...
    <link rel="stylesheet" href="../css/update_dosen.css"> 
</head>
    ...
    <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="edit_dosen.php?id=<?php echo $row['id_dosen']; ?>">
                        <button type="button" class="btn btn-warning btn-sm">Edit</button></a> |
                        <a href="hapus_dosen.php?id=<?php echo $row['id_dosen']; ?>">
