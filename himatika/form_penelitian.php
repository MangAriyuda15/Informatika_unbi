...
<head>
  ...
  <link rel="stylesheet" href="../css/form_penelitian.css">
  <title>Form Input Penelitian</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | Penelitian</h5>
    </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="inputFile2">Choose file</label>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="custom-file">
                  ...
                  <label class="custom-file-label" for="inputFile3">Choose file</label>
                </div>
              </div>
            </div>
          </div>
