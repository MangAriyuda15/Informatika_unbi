...
<head>
  ...
  <link rel="stylesheet" href="../css/form_prodi.css">
...
<body>
          ...
          <div class="container-fluid color1">
            ...
            <div class="collapse navbar-collapse menu1 " id="navbarSupportedContent">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="form_pengumuman">form pengumuman</a>
                </li>
                <li class="nav-item">
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | Prodi</h5>
    </div>
    <form method="POST" action="simpan_prodi.php" enctype="multipart/form-data">
      <div class="form-group menu1">
        <label for="judul">Judul</label>
        <input type="text" name="judul" class="form-control" id="judul"></textarea>
      </div>
      <br>
      ...
      <a href="tampil_prodi.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
