...
<head>
    ...
    <title>Data Tables DUNIA IT</title>
    ...
    <link rel="stylesheet" href="../css/update_dunia_it.css">
</head>
    ...
    <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <td><?php echo $row['judul']?></td>
                ...
                <td><a href="edit_dunia_it.php?id=<?php echo $row['id_duniait']; ?>">
                        <button type="button" class="btn btn-warning btn-sm">Edit</button></a> |
                        <a href="hapus_dunia_it.php?id=<?php echo $row['id_duniait']; ?>">
