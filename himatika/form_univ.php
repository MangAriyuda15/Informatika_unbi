...
<head>
  ...
  <link rel="stylesheet" href="../css/form_univ.css">
  <title>Form Input Universitas</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | Universitas</h5>
    </div>
    <form method="POST" action="simpan_univ.php" enctype="multipart/form-data">
      ...
      <a href="tampil_univ.php "class="btn btn-primary">Edit</a>
