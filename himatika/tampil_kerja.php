...
<head>
    ...
    <title>Data Tables Prospek Kerja</title>
    ...
    <link rel="stylesheet" href="../css/update_kerja.css">
</head>
    ...
    <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="edit_kerja.php?id=<?php echo $row['id_kerja']; ?>">
                        <button type="button" class="btn btn-warning btn-sm">Edit</button></a> |
                        <a href="hapus_kerja.php?id=<?php echo $row['id_kerja']; ?>">
