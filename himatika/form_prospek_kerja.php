...
<head>
  ...
  <title>Form Input PROSPEK KERJA</title>
...
<body>
  ...
  <div class="container-fluid warna">
    <div class="menu1">
      <h5>Form Input Berita | PROSPEK KERJA</h5>
    </div>
    <form method="POST" action="simpan_kerja.php" enctype="multipart/form-data">
      ...
      <a href="tampil_kerja.php "class="btn btn-primary">Edit</a>
    </form>
  </div>
  <!--end form-->
